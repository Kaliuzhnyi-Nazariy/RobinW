...
const Footer = () => {
  return (
    <Section extraStyles="bg-[var(--levelOne)] py-12 grid min-[768px]:grid-rows-[minmax(48px,_1fr)] min-[768px]:grid-cols-4 min-[768px]:pt-20 min-[768px]:pb-14 ">
      ...
      <ul className="mt-12 w-[154px] text-[16px] min-[768px]:col-3 min-[768px]:mt-0 min-[1440px]:justify-self-center">
        ...
        <li className="w-full h-12 flex items-center cursor-pointer">About</li>
      ...
      <ul className="w-[154px] text-[16px] ">
        <li className="w-full h-12 flex items-center cursor-pointer">Store</li>
